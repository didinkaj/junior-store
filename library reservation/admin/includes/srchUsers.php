...
<form method="POST" action="srchUsers.php">
	<input type="text" name="keyword" value="<?php echo $keyword; ?>" placeholder=" Search Keyword" class="srchTxt"/>
...
$query = mysql_query("SELECT * FROM users WHERE status = '1' AND
			fname LIKE '$keyword%'
