...
<div id="sublink">
	...
	<b><a href="#" class="subLink">Pending Events (<b><?php echo $numPending ?></b>)</a></b> |
...
?>	
	...
	<center>
	<a href="functions/approve.php?target=<?php echo $target ?>">
	<div class="linkbtn">
		Approved
	</div>
	</a>	

	<a href="functions/delpending.php?target=<?php echo $target ?>">
	<div class="linkbtn">
		Delete
	</div>
	</a>
