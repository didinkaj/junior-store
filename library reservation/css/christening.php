...
if($time == ""){
		...
		$selected_event = '<option value="Christening" class="not">Christening</option>';
	...
	if($numDate >= 1){
		...
		echo "<script>window.location='reservationC.php?event=$event&date=$getdate&time=$time'</script>";
	}}}
?>