...
<html>
<head>
	<title>Reply Message | UOE Main Library, Main compus, eldoret</title>
...
<div id="contents">
	<div id="main-content">
	<br /><br />
	<center><h1 class="title">Reply Message</h1></center>
		<?php include "includes/quickReply.php"; ?>
		<?php include "functions/quickReply.php"; ?>
	</div>
</div><!--#contents-->
