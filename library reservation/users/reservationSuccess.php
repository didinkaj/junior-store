...
<html>
<head>
	<title>Reservation Complete | UOE Main Library, Main compus, eldoret</title>
...
<center><hr width="80%" /></center>
	...
	<div id="contents"><br />
		<center><h1 class="title">Reservation Complete</h1></center>
		<?php include 'includes/reservationSuccess.php'; ?>
	</div><!--#contents-->
	<br />
	<div id="footer">
