...
if($time == ""){
		...
		$selected_event = '<option value="Free WIFI" class="not">Free WIFI</option>';
	...
	if($numDate >= 1){
		...
		echo "<script>window.location='reservationC.php?target=$getID&event=$event&date=$getdate&time=$time'</script>";
	}}}
?>